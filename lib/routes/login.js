...
router.post('/', csrfProtection, function (req, res, next) 
{
    ...
    if (!(req.body.email === 'foo@ga4ghWRONG.org' && req.body.password === 'foobar')) 
    {
...
// async function
async function checkKratosLogin (flowId) 
{
    var final_url = process.env.KRATOS_PUBLIC_URL + "self-service/login/flows?id=" + flowId;
    ...
    Console.log(data); // Print and see the data
    return data;
}
